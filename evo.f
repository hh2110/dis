...
! DEFINE VARIABLES   
      ...
      REAL :: ALPHAF, OMALPHAF        !! ALPHA and 1-ALPHA 4 GS
...
!-----------------------------------------------------------------------     
     ...
     &          2*SIN(2*(-E1+E3)*PI))+ 
     &        GC(PHID,5)*(-4*SIN(2*(2*E1-E2-E3)*PI)+
     &          2*SIN(2*(-E1+2*E2-E3)*PI)+ 
     &          2*SIN(2*(-E1-E2+2*E3)*PI))+ 
     &        GC(PHID,6)*(-3*SIN(3*(E1-E2)*PI)+
     &          3*SIN(3*(-E1+E3)*PI))+ 
     &        GC(PHID,7)*(-6*SIN(3*(2*E1-E2-E3)*PI)+
     &          3*SIN(3*(-E1+2*E2-E3)*PI)+ 
     &          3*SIN(3*(-E1-E2+2*E3)*PI))+
     &        GC(PHID,8)*(-4*SIN(4*(E1-E2)*PI)+
     &          4*SIN(4*(-E1+E3)*PI))+ 
     &        GC(PHID,11)*(2*COS(2*(E1-E2)*PI)-
     &          2*COS(2*(-E1+E3)*PI))+ 
...
!-----------------------------------------------------------------------          
     ...
     &        GC(PHID,8)*(-4*SIN(4*(E1-E2)*PI)+
     &          4*SIN(4*(-E1+E3)*PI))+ 
     &        GC(PHID,9)*(-5*SIN(5*(E1-E2)*PI)+
     &          5*PI*SIN(5*(-E1+E3)*PI))+ 
     &        GC(PHID,10)*(COS((E1-E2)*PI)-COS((-E1+E3)*PI))+ 
     &        GC(PHID,11)*(2*COS(2*(E1-E2)*PI)-
     &          2*COS(2*(-E1+E3)*PI))+ 
     &        GC(PHID,12)*(3*COS(3*(E1-E2)*PI)-
     &          3*COS(3*(-E1+E3)*PI))+ 
     &        GC(PHID,13)*(4*COS(4*(E1-E2)*PI)-
     &          4*COS(4*(-E1+E3)*PI))+ 
